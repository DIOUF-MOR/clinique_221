 ...
 */
final class Version20250411090601 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE consultation (id INT NOT NULL, dossier_medical_id INT DEFAULT NULL, medecin_id INT NOT NULL, ordonnance_id INT DEFAULT NULL, observations VARCHAR(255) NOT NULL, INDEX IDX_964685A67750B79F (dossier_medical_id), INDEX IDX_964685A64F31A84 (medecin_id), UNIQUE INDEX UNIQ_964685A62BF23B8F (ordonnance_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE prestation (id INT NOT NULL, responsable_prestation_id INT DEFAULT NULL, dossier_medical_id INT DEFAULT NULL, type VARCHAR(50) NOT NULL, description VARCHAR(100) NOT NULL, resultat VARCHAR(50) NOT NULL, date_realisation DATETIME NOT NULL, INDEX IDX_51C88FADE366EFB2 (responsable_prestation_id), INDEX IDX_51C88FAD7750B79F (dossier_medical_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE rendez_vous (id INT AUTO_INCREMENT NOT NULL, secretaire_id INT DEFAULT NULL, patient_id INT DEFAULT NULL, date_heure DATETIME NOT NULL, date_creation DATETIME NOT NULL, statut VARCHAR(25) NOT NULL, dtype VARCHAR(255) NOT NULL, INDEX IDX_65E8AA0AA90F02B2 (secretaire_id), INDEX IDX_65E8AA0A6B899279 (patient_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, prenom VARCHAR(25) NOT NULL, nom VARCHAR(25) NOT NULL, is_is_active TINYINT(1) NOT NULL, dtype VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE consultation ADD CONSTRAINT FK_964685A6BF396750 FOREIGN KEY (id) REFERENCES rendez_vous (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE prestation ADD CONSTRAINT FK_51C88FADBF396750 FOREIGN KEY (id) REFERENCES rendez_vous (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE consultation DROP FOREIGN KEY FK_964685A6BF396750
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE prestation DROP FOREIGN KEY FK_51C88FADBF396750
        SQL);
        $this->addSql(<<<'SQL'
